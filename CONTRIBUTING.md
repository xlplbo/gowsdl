...
* In Github, fork `https://github.com/xlplbo/gowsdl` to your own account
* Get the package using "go get": `go get github.com/xlplbo/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/xlplbo/gowsdl/`
